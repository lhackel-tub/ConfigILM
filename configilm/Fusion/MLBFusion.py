...
class MLB(AbstractFusion):
    def __init__(
        ...
        """
        Initializes internal Module state of Multi-Modal Hadamard Product for Low-rank
        Bilinear Pooling Fusion of "Hadamard Product for Low-rank Bilinear Pooling".
        Linear mapping of inputs to higher dimension paired with a point-wise
        multiplication and output mapping.
        ...
        :returns: MLB-Fusion torch.nn module
        """
        super().__init__()
    ...
    def forward(self, input_0: torch.Tensor, input_1: torch.Tensor) -> torch.Tensor:
        """
        Forward call to Multi-Modal Hadamard Product for Low-rank Bilinear Pooling
        Fusion
