...
class RSVQAHRDataSet(Dataset):
    def __init__(
        ...
        super().__init__()
        assert split in [None, "train", "val", "test", "test_phili"], (
...
if __name__ == "__main__":
    import time
    ds = RSVQAHRDataSet(root_dir=resolve_data_dir(data_dir=None, allow_mock=True),
                        split=None, max_img_idx=-1, use_file_format="tif")
